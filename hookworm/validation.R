...
fit_dsgm <- readRDS("hookworm/Data/fit_sth_dsgm.rds")
anpit_one <- readRDS("hookworm/anpit_hk_one.rds")

plot_AnPIT(anpit_one, which = "conditional")
...
library(dplyr)
plot_zero_calibration(anpit_one, by_location = TRUE,
                      xlim3 = c(0, 0.2), ylim3 = c(0, 0.15))
